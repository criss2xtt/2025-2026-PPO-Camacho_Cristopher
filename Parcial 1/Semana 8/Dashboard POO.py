...
Estudiante: Cristopher Camacho
Curso: Programación Orientada a Objetos (C)
Descripción: Archivo personalizado para la gestión y ejecución
de ejemplos y proyectos del curso.
"""
import os
import subprocess
...
def mostrar_menu():
    # Diccionario que almacena las unidades disponibles del curso
    ruta_base = os.path.dirname(__file__)
    # Se modifico poniendo las materias vistas en cada unidad
    unidades = {
        '1': 'Unidad 1  - Fundamentos de Programacion',
        '2': 'Unidad 2  - Programacion orientada a objetos'
    }

    # Aqui se adapto conforme a mi nombre, a la materia y curso
    while True:
        print("\n===== DASHBOARD POO =====")
        print("Estudiante: Cristopher Camacho")
        print("Curso: Programación Orientada a Objetos (c)\n")
